...
<View>
        <Text style={{marginTop:20 , marginBottom:12,fontSize:15,color:"#424242"}}>Bu ilanı paylaş</Text>
...
<View style={{marginTop:"6%", marginBottom:"11%", borderWidth:1.2,borderColor:"#FF3E55",height:46,borderRadius:22,flexDirection:"row", alignItems:"center",justifyContent:"center"}}>
